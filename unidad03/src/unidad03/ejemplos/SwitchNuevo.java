...
public class SwitchNuevo {
	...
	public static void main(String[] args) {
		...
		switch (opcion){
			...
			case 3 -> System.out.println("Has seleccionado la opción 3. ");
			case 4 -> System.out.println("Has seleccionado la opción 4. ");
			case 5 -> System.out.println("Has seleccionado la opción 5. ");
